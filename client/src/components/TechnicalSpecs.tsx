      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-300">Modern functional components with hooks</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300">Type-safe development with excellent IntelliSense</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold mb-2">TailwindCSS</h4>
            <p className="text-gray-300">Utility-first CSS framework for rapid development</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold mb-2">Storybook</h4>
            <p className="text-gray-300">Component documentation and development tool</p>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="bg-gray-800 rounded-xl p-6">
            ...
            <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm">
              ...
              <div className="text-green-400 mb-4">npm install @storyfreak/components</div>
              
              <div className="text-gray-400 mb-2"># Import components</div>
              <div className="text-blue-300 mb-4">import {`{ InputField, DataTable }`} from '@storyfreak/components';</div>
              
              <div className="text-gray-400 mb-2"># Use in your React app</div>
              <div className="text-yellow-300">&lt;InputField variant="outlined" size="md" /&gt;</div>
            </div>
          </div>
        </div>
      </div>
