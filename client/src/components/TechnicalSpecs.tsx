    ...
    <section className="bg-muted py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h3 className="text-3xl font-bold mb-4 text-foreground">Technical Specifications</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold mb-2 text-foreground">React</h4>
            <p className="text-muted-foreground">Modern functional components with hooks</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold mb-2 text-foreground">TypeScript</h4>
            <p className="text-muted-foreground">Type-safe development with excellent IntelliSense</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold mb-2 text-foreground">TailwindCSS</h4>
            <p className="text-muted-foreground">Utility-first CSS framework for rapid development</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold mb-2 text-foreground">Storybook</h4>
            <p className="text-muted-foreground">Component documentation and development tool</p>
          </div>
        </div>

        <div className="mt-16">
          <div className="bg-card border border-border rounded-xl p-6">
            <h4 className="text-xl font-semibold mb-4 text-foreground">Quick Start</h4>
            <div className="bg-muted/50 rounded-lg p-4 font-mono text-sm">
              <div className="text-muted-foreground mb-2"># Install dependencies</div>
              <div className="text-primary mb-4">npm install @storyfreak/components</div>
              
              <div className="text-muted-foreground mb-2"># Import components</div>
              <div className="text-accent-foreground mb-4">import {`{ InputField, DataTable }`} from '@storyfreak/components';</div>
              
              <div className="text-muted-foreground mb-2"># Use in your React app</div>
              <div className="text-primary">&lt;InputField variant="outlined" size="md" /&gt;</div>
            </div>
          </div>
        </div>
      </div>
